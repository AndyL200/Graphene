...
void Dump(char *filename)
{
  ...
  XGWrite(&oldsigma, 4, 1, DMPFile, "float");
  XGWrite(&extq, 4, 1, DMPFile, "float");
  XGWrite(&extq_1, 4, 1, DMPFile, "float");
  XGWrite(&extq_2, 4, 1, DMPFile, "float");
  XGWrite(&extq_3, 4, 1, DMPFile, "float");
  XGWrite(&nsp, 4, 1, DMPFile, "int");
  XGWrite(jwall, 4, nsp, DMPFile, "float");
...
void Restore(char *filename)
{
  ...
  XGRead(&extq, 4, 1, DMPFile, "float");
  XGRead(&extq_1, 4, 1, DMPFile, "float");
  XGRead(&extq_2, 4, 1, DMPFile, "float");
  XGRead(&extq_3, 4, 1, DMPFile, "float");
  XGRead(&nsp, 4, 1, DMPFile, "int");
  XGRead(jwall, 4, nsp, DMPFile, "float");
